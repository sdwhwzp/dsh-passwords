...
function makeAlpha3Root(root: string, settings: string | null, connection: string): string {
...
test('alpha.3 gateway refuses startup when the Cookie bridge is unavailable', () => {
