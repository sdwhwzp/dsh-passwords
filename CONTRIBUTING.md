...
- Node.js `22.19+` or `24+`
- The private Harness `0.1.7-rc.2` checkout supplies native tenant extensions. Development packages link to it; candidate and production acceptance are recorded separately from upstream release results.
- npm and git
