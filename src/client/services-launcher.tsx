...
export function ServicesLauncher({ t, wide, onOpen }: PropsLocale<'dshpw'> & { wide: boolean; onOpen(): void }) {
  return h('button', { type: 'button', onClick: onOpen, className: `dshpw-sidebar-workspace-action${wide ? '' : ' compact'}`, title: t('servicesTitle'), 'aria-label': t('servicesTitle') },
