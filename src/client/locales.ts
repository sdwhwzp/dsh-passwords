...
export const zh = {
  ...
  // 用户本机工作区
  localTitle: '本机工作区',
  localHint: '在使用者电脑运行轻量助手后，工作区会自动出现在侧栏；文件读写和搜索直接作用于原目录。',
  localWindowsTitle: 'Windows 一键助手',
  localWindowsHint: '下载后双击运行，首次粘贴下方完整配对命令并授权文件夹；以后双击即可自动连接。',
  ...
  localShellWarning: 'Shell 默认关闭。确需执行本机命令时，在配对命令末尾添加 --allow-shell；命令可访问该系统用户权限范围。',
  localPair: '生成配对命令',
  localPairReady: '配对命令已生成',
  localFolderPlaceholder: '替换为本机目录',
  localCopy: '复制',
  localCopied: '配对命令已复制',
  localCopyFailed: '复制失败，请手动选择命令文本',
  localExpires: '配对码将在 {time} 失效，只能使用一次。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  localHint: 'Run the lightweight companion on the user’s computer. The workspace then appears in the sidebar, and file operations affect the original folder.',
  localWindowsTitle: 'Windows one-click companion',
  localWindowsHint: 'Download and double-click it. On first launch, paste the full pairing command below and authorize a folder; later, double-click to reconnect.',
  ...
  localInstallCommand: 'npm install -g github:sdwhwzp/dsh-passwords#dev',
  localShellWarning: 'Shell is off by default. Append --allow-shell only when local commands are required; commands can access everything permitted to that OS user.',
  localPair: 'Generate pairing command',
  localPairReady: 'Pairing command generated',
  localFolderPlaceholder: 'replace-with-local-folder',
  localCopy: 'Copy',
  localCopied: 'Pairing command copied',
  localCopyFailed: 'Copy failed; select the command manually',
  localExpires: 'The one-time pairing code expires at {time}.',
