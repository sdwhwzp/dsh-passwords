...
export const zh = {
  ...
  updateManualCmd: '当前环境需要手动更新：',
  updateCheck: '立即检查',
  updateChecking: '正在检查更新…',
  updateCheckStarted: '已完成检查，状态已刷新',
  updateApplyNow: '立即安装重启',
  updateApplyStarted: '已触发安装，若环境支持会自动重启网页服务；否则请按提示手动重启',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  updateManualCmd: 'This environment requires manual update:',
  updateCheck: 'Check now',
  updateChecking: 'Checking for updates…',
  updateCheckStarted: 'Update check complete; status refreshed',
  updateApplyNow: 'Install & restart now',
  updateApplyStarted: 'Install triggered; the web service restarts automatically where supported, otherwise follow the manual instructions',
